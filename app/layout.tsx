...
export const metadata: Metadata = {
  title: "Kuldeep Khalotiya — Aspiring Software Engineer",
  description:
    "Portfolio de Kuldeep Khalotiya — Aspiring Software Engineer (React, Python, Machine Learning).",
  keywords: ["Kuldeep Khalotiya", "Software Engineer", "React", "Python", "Machine Learning", "Full-stack"],
  authors: [{ name: "Kuldeep Khalotiya" }],
  creator: "Kuldeep Khalotiya",
  publisher: "Kuldeep Khalotiya",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    url: "https://kuldeepkhalotiya.dev",
    siteName: "Kuldeep Khalotiya — Portfolio",
    title: "Kuldeep Khalotiya — Aspiring Software Engineer",
    description: "Aspiring Software Engineer specializing in React, Python and Machine Learning.",
    images: [
      {
        url: "/images/profile.jpg",
        width: 1200,
        height: 630,
        alt: "Kuldeep Khalotiya — Software Engineer",
      },
    ],
  },
  twitter: {
    ...
    title: "Kuldeep Khalotiya — Aspiring Software Engineer",
    description: "Aspiring Software Engineer specializing in React, Python and Machine Learning.",
    creator: "@kuldeepkhalotiya",
    images: ["/images/profile.jpg"],
  },
  alternates: {
    canonical: "https://kuldeepkhalotiya.dev",
    languages: {
      "en-US": "https://kuldeepkhalotiya.dev",
    },
  },
  generator: "v0.app",
  icons: {
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@graph": [
                {
                  "@type": "Person",
                  "@id": "https://kuldeepkhalotiya.dev/#person",
                  name: "Kuldeep Khalotiya",
                  description:
                    "Aspiring Software Engineer specializing in React, Python and Machine Learning",
                  jobTitle: ["Software Engineer", "Full-stack Developer", "Machine Learning Engineer"],
                  worksFor: [],
                  nationality: "India",
                  url: "https://kuldeepkhalotiya.dev",
                  image: "https://kuldeepkhalotiya.dev/images/profile.jpg",
                  sameAs: [
                    "https://linkedin.com/in/kuldeep-khalotiya",
                    "https://github.com/Kuldeep-2303",
                  ],
                  knowsAbout: ["React", "Python", "Machine Learning", "Django", "Flask", "TensorFlow", "OpenCV"],
                  alumniOf: "Parul University",
                  hasOccupation: {
                    "@type": "Occupation",
                    name: "Aspiring Software Engineer",
                    description: "Builds scalable web apps and ML-powered systems",
                  },
                },
                {
                  "@type": "WebSite",
